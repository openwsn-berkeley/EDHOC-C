...
void aes_enc(unsigned char *state, const unsigned char *expanded_key);

//=========================== public ==========================================

int aes128_enc(uint8_t buffer[16], uint8_t key[16]) {
...
// expand the key
void expand_key(unsigned char *expanded_key, const unsigned char *key) {
